...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.addEventListener("click", function (event) {
    if (
      event.target !== addPopup &&
      !addPopup.contains(event.target) &&
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  saveChangesButton.addEventListener("click", function () {
    ...
    if (validateTitle(newTitle) && validateSubtitle(newSubtitle)) {
      ...
      document.querySelector(".profile__content-subtitle").textContent =
        newSubtitle;
...
function removeCard(trashButton) {
  trashButton.addEventListener("click", function () {
    let card = trashButton.closest(
      ".cards__one, .cards__two, .cards__three, .cards__for, .cards__five, .cards__six, .cards__new"
    );
    card.remove();
  });
}
...
function addTrashButtonEvents() {
  document
    .querySelectorAll(
      ".cards__one-trash, .cards__two-trash, .cards__three-trash, .cards__for-trash, .cards__five-trash, .cards__six-trash"
    )
    .forEach(removeCard);
}
...
document
  .querySelectorAll(
    ".cards__one-image, .cards__two-image, .cards__three-image, .cards__for-image, .cards__five-image, .cards__six-image, .cards-new-image"
  )
  .forEach(function (el) {
    el.onclick = function () {
      const modal = document.getElementById("modal");
